...
db.lpUsers = require('../models/lpuser.model')(sequelize)
db.iPoints = require('../models/inspectionpoint.model')(sequelize)

// Relations
db.users.belongsTo(db.roles, {foreignKey: 'rol_id', sourceKey: 'rol_id'})
